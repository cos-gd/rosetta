...
If it fails YOU MUST ASK USER (as this is highly critical and unexpected)! If context output was truncated and a file path was provided, you MUST immediately read the full file before proceeding even if large! Preview is NOT ENOUGH!
