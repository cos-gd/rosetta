...
- `ACQUIRE <file[.md]> FROM KB` => read local plugin files:
  ...
  - Search in: `commands/<file-name-with-extension>`
...
- `commands/coding-flow.md`: "Rosetta coding and implementation workflow, includes discovery, tech specs, tech plan, subagent plan review, user plan review, implementation, subagent review implementation, validation, user review, and final validation with reviewer gates, HITL gates, and subagent delegation."
